...
data class TwitterUser(
    ...
    val location: String,
    @ColumnInfo(name = "profile_location") val profileLocation: String,
    ...
    @ColumnInfo(name = "profile_background_tile") val profileBackgroundTile: String,
